...
export const MERCHANT_PRODUCTS: readonly MerchantProduct[] = [
  { id: 'p1', name: 'شامبو أرغان 400مل', sku: 'SH-ARG-400', variantCount: 0, available: 3, status: 'active', updatedAt: 'اليوم، 9:40 ص' },
  { id: 'p2', name: 'قميص قطني رجالي', sku: 'TS-CTN-M', variantCount: 4, available: 26, status: 'active', updatedAt: 'أمس' },
  { id: 'p3', name: 'كريم زبدة الشيا', sku: 'CR-SHEA', variantCount: 2, available: 2, status: 'active', updatedAt: 'أمس' },
  { id: 'p4', name: 'عطر العود الملكي 50مل', sku: 'PF-OUD-50', variantCount: 2, available: 0, status: 'active', updatedAt: '14 أغسطس' },
  { id: 'p5', name: 'سجادة صلاة مخملية', sku: 'RG-VLT-01', variantCount: 3, available: 18, status: 'active', updatedAt: '13 أغسطس' },
  { id: 'p6', name: 'مجموعة عناية بالبشرة', sku: 'SK-SET-01', variantCount: 0, available: 11, status: 'draft', updatedAt: '12 أغسطس' },
  { id: 'p7', name: 'زيت جوز الهند العضوي', sku: 'OL-CCN-250', variantCount: 0, available: 7, status: 'active', updatedAt: '11 أغسطس' },
